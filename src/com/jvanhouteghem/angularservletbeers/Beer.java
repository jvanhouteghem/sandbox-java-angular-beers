...
/**
 * L'objet Beer est utilisé pour la création, la suppression et la mise à jour des beers
 * On utilise notamment la méthode getBeers() pour faire un appel au DAO (mongodb)
 * @author vjona
 *
 */
public class Beer {
	...
	// On peux le remplace pour qu'il garde le premier nom de la biere si on ne veut pas que la personne le génère
	...
	// Appel DAO, le code en commentaire est l'équivalent de ce que la BDD peut retourner
